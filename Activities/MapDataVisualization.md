...
1. Switch the map projection to use Mercator projection:
    - Open the Global tab
    - Click Projection
...
### PICK UP AGAIN HERE
https://docs.mapbox.com/help/tutorials/create-a-map-with-data-visualization-component/?step=3
...
In the `body`, you'll add the [heading](https://www.w3schools.com/tags/tag_hn.asp) Map 1, a div element with the id "map1" where you want your first map to be, and a line or [horizontal rule](https://www.w3schools.com/tags/tag_hr.asp) below the map. Tip: Click the links in the instructions to view the HMTL reference for these tags:
